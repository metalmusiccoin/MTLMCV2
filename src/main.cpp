...
int64 nChainStartTime = 1424651078;
...
const string strMessageMagic = "MetalMusicCoin2 Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
    {
        nSubsidy = 2000000 * COIN;  // 2 Million coins
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in MetalMusicCoin2
    bool fStrictPayToScriptHash = true; // Always active in MetalMusicCoin2
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MetalMusicCoin2", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "February 23, 2015. Metal Music Coin Version 2.0 Has Been Created. 1424651078";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1424651078;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1364026;
        ...
        assert(block.hashMerkleRoot == uint256("52cf6c09bd5a7fb8606ad6b4e7ddb0a49b379aaec79228f832931fd8de9a0b91"));
